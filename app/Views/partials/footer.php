...
<footer class="Footer_footer__3eK23">
	<div class="container">
		<div class="justify-content-between row">
			<div class="col-md-5 col-xl-5"><h5 class="text-white fw-bold">Many desktop publishing</h5>
		...
		<div class="my-5 justify-content-between row">
			<div class="d-flex flex-column justify-content-between col-md-3 col-xl-5">
				...
				<div class="Footer_socialLinks__1Ix7R"><a class="Footer_socialLink__2wEBV" target="_blank" rel="noopener noreferrer"
					...
					</a><a class="Footer_socialLink__2wEBV" target="_blank" rel="noopener noreferrer"
					...
					</a><a class="Footer_socialLink__2wEBV" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/flatlogic/">
						<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path fill-rule="evenodd" clip-rule="evenodd"
